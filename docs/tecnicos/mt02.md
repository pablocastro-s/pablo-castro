...
![Paso 1 configuración render](<../images/MT02/Render 01.png>) ![Paso 2 configuración render](<../images/MT02/Render 02.png>) ![Paso 3 configuración render](<../images/MT02/Render 03.png>) ![Paso 4 configuración render](<../images/MT02/Render 04.png>)
...
<ul><li>[01. Cuerpo frontal](<../archivos linkeados/MT02/Piezas STL/01. Cuerpo frontal.stl>){:download}</li>
<li>[02. Cuerpo posterior](<../archivos linkeados/MT02/Piezas STL/02. Cuerpo posterior.stl>){:download}</li>
<li>[03. Tapa posterior](<../archivos linkeados/MT02/Piezas STL/03. Tapa posterior.stl>){:download}</li>
<li>[04. Tapa baterias](<../archivos linkeados/MT02/Piezas STL/04. Tapa baterias.stl>){:download}</li>
<li>[05. Slider apertura.stl](<../archivos linkeados/MT02/Piezas STL/05. Slider apertura.stl>){:download}</li>
<li>[06. Obturador.stl](<../archivos linkeados/MT02/Piezas STL/06. Obturador.stl>){:download}</li>
<li>[07. Frente visor.stl](<../archivos linkeados/MT02/Piezas STL/07. Frente visor.stl>){:download}</li></ul>
